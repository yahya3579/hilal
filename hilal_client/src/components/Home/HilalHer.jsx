...
const fetchAllArticles = async () => {
    const res = await axios.get(`${import.meta.env.VITE_API_URL}/api/articles/category/hilal-her`)
        ...
        <div className="py-2 px-4 font-poppins">
            ...
            <div className="border-t-[3px] border-red-600">
                <div className="bg-white py-2 mb-2">
                    <h2 className="heading-text-primary">Hilal her - english</h2>
                </div>
...
export default HilalHerComponent;