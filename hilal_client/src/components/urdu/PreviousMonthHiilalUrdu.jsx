                                ...
                                <div key={index} className="overflow-hidden w-full shadow-md bg-gray-100">
                                    <div className="w-full h-[373px] bg-gray-200 flex items-center justify-center">
                                        <div className="text-center">
                                            ...
                                            <p className="text-gray-500 text-sm font-medium" dir='rtl'>کوئی میگزین نہیں</p>
                                        </div>
                                    </div>
                                    <div className="p-2 bg-white">
                                        <h3 className="text-sm font-medium text-gray-400 text-center leading-tight" dir='rtl'>
                                            کوئی میگزین دستیاب نہیں
                                        </h3>
                                        <p className="text-xs text-gray-300 text-center mt-1" dir='rtl'>
                                            (کوئی ڈیٹا نہیں)
                                        </p>
                                    </div>
                                </div>
