        ...
        <div className="bg-white px-4 font-poppins">
            <div className="border-t-[3px] border-red-600">
                <div className="py-2 mb-1">
                    <h2 className="heading-text-primary">نیوز لیٹر حاصل کریں</h2>
                </div>
                <div className="p-4 flex flex-col gap-y-8">
                    <p className="text-sm text-gray-500 mb-4 leading-relaxed">
                        تازہ ترین اپڈیٹس حاصل کرنے کے لیے ہمارے نیوز چینل کو سبسکرائب کریں۔
                    </p>
