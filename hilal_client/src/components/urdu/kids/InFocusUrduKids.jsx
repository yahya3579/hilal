...
import { CommonCard2Urdu } from "../../shared/urdu/CommonCard2Urdu";
import CommonCard3Urdu from "../../shared/urdu/CommonCard3Urdu";
            ...
            <div className="border-t-[3px] border-red-600">
                ...
                <div className="py-2">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        {data.length > 0 && (
                            <CommonCard2Urdu key={data[0].id} data={data} />
                        )}

                        {/* Smaller Articles */}
                        <div className="grid grid-cols-2 gap-y-2 gap-x-4">
                            {data.slice(1, 5).map((article) => (
                                <CommonCard3Urdu key={article.id} article={article} />
                            ))}
                        </div>
                    </div>
                </div>
