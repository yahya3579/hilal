...
//       <h1 className="text-[#DF1600] font-medium text-xl sm:text-2xl tracking-tight uppercase font-poppins mb-4 sm:mb-6">
//         Our Contributors
//       </h1>

//       {/* Inquiry Text */}
//       <p className="text-[#292D32] font-poppins text-base sm:text-[19.32px] capitalize mb-4 sm:mb-6">
//         To inquire about advertising opportunities, please contact:
//       </p>

//       {/* Muhammad Bilal Section */}
//       <div className="mb-6 sm:mb-8">
//         <h2 className="text-[#292D32] font-poppins font-bold text-xl sm:text-2xl capitalize mb-2">
//           Muhammad Bilal
//         </h2>
//         <p className="text-[#292D32] font-poppins italic text-base sm:text-[19.32px] capitalize">
//           Assistant Manager Outreach & Marketing
//         </p>
//         <p className="mt-3 sm:mt-4 text-[#292D32] font-poppins text-base sm:text-[19.32px] capitalize">
//           The Pakistan Armed Forces Magazine, Inter-Services Public Relations Hilal Road, Rawalpindi.
//         </p>
//       </div>

//       {/* To Advertise Section */}
//       <div className="mb-6">
//         <h3 className="text-[#DF0404] font-poppins font-bold text-base sm:text-[19.32px] capitalize mb-3 sm:mb-4">
//           To advertise with us:
//         </h3>

//         <div className="space-y-2 mb-4">
//           <p className="text-[#292D32] font-poppins text-base sm:text-[19.32px] capitalize break-all sm:break-normal">
//             For info: chbilal.hilal@gmail.com
//           </p>
//           <p className="text-[#292D32] font-poppins text-base sm:text-[19.32px] capitalize break-all sm:break-normal">
//             For Ad submission: hilal.ads786@gmail.com
//           </p>
//         </div>
...
//           <span className="text-[#292D32] font-poppins text-base sm:text-[19.32px] capitalize">
//             051-6104118
//           </span>
//         </div>
//       </div>
...
//       {/* Footer Note */}
//       <p className="mt-6 sm:mt-8 text-[#676767] font-poppins text-base sm:text-[19.32px] capitalize">
        ...
        <div className="space-y-3 sm:space-y-2 mb-4">
          <p className="text-[#292D32] font-poppins text-sm sm:text-[19.32px] capitalize break-all sm:break-normal leading-relaxed">
            For info: <span 
              ...
              onClick={() => window.location.href = 'mailto:chbilal.hilal@gmail.com'}
            >
              chbilal.hilal@gmail.com
            </span>
          </p>
          <p className="text-[#292D32] font-poppins text-sm sm:text-[19.32px] capitalize break-all sm:break-normal leading-relaxed">
            For Ad submission: <span 
              className="underline hover:text-[#DF1600] transition-colors cursor-pointer"
              onClick={() => window.location.href = 'mailto:hilal.ads786@gmail.com'}
            >
