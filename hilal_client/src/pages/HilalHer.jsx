...
const HilalHerComponent = lazy(() => import("../components/Home/HilalHer"));
...
const InFocusSectionHer = lazy(() => import("../components/Home/her/InFocusSectionHer"));
const TrendingHilalHerSection = lazy(() => import("../components/Home/her/TrendingHilalHer"));
    ...
    return (
        <>
            <div className="flex lg:flex-row flex-col">
                {/* LEFT COLUMN - Critical content loads first */}
