        ...
        <div className="min-h-screen bg-white p-6">
            <div className="">
                ...
                <div className="bg-white">
                    <div className="border-t-[3px] border-[#DF1600] p-4">
                    ...
                    <div className=" space-y-6">
                        ...
                        <div>
                            <label className="block  color-gray mb-2 font-montserrat  font-semibold text-[14px] leading-[100%] tracking-normal text-center align-middle">Article Cover</label>
                            <div
