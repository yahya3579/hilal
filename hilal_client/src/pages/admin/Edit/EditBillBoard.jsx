            ...
            <div className="">
                ...
                <div className="bg-white">
                    <div className="border-t-[3px] border-[#DF1600] py-4">
                        <h2 className="font-poppins font-medium text-[24px] leading-[100%] tracking-[-0.03em] uppercase color-primary">Edit Bill board</h2>
                    </div>
                        ...
                        <div className="md:w-[90%] flex flex-col md:space-y-8 space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6">
                                ...
                                <div className="col-span-3">
                                    <label className="block  color-gray mb-2 font-montserrat  font-semibold text-[14px] leading-[100%] tracking-normal  align-middle">Bill Board Title</label>
                                    <input
                                        type="text"
