...
export default function EditAuthor() {
    ...
    const uploadAuthor = async (formData) => {
        ...
        if (formData.author_image) {
            ...
            imageUrl = await uploadToCloudinary(formData.author_image);
    ...
    const handleSubmit = (e) => {
        ...
        mutation.mutate(formData, {
            onSuccess: () => {
                alert(authorId ? "Author updated successfully!" : "Author uploaded successfully!");
                setFormData({
                    author_image: "",
                    author_name: "",
                    email: "",
            ...
            onError: (error) => {
                alert(`Error ${authorId ? "updating" : "uploading"} author: ${error.response?.data || error.message}`);
                setIsSubmitting(false);
            },
        });
    };
