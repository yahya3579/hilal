...
const SignUp = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col lg:flex-row">
            ...
            <div className="w-full lg:w-[67%] bg-gray-50 flex flex-col">
                {/* Header Navigation */}
                ...
                <div className="flex-1 flex items-center justify-center p-4 sm:p-6">
                    <div className="w-full flex flex-col space-y-3 sm:space-y-4 max-w-md">
                        {/* Form Header */}
                        <h1 className="roboto font-bold text-4xl sm:text-5xl lg:text-[64px] leading-tight sm:leading-[37.5px] tracking-[-0.5px] text-center capitalize text-[#DF1600]">Sign Up</h1>
                        <p className="font-bold text-base sm:text-lg lg:text-[20px] leading-tight sm:leading-[37.5px] tracking-[-0.5px] text-center text-[#424242]">Create your account</p>

                        {/* Google Sign Up Button */}
                        <button
                            onClick={handleGoogleSignUp}
                            className="w-full bg-[#D9D9D9] hover:bg-gray-300 font-zen font-normal text-sm sm:text-[16px] leading-tight sm:leading-[25.6px] tracking-[0px] text-[#424242] py-2.5 sm:py-3 px-4 rounded-full flex items-center justify-center mb-4 sm:mb-6 transition-colors duration-200"
                        >
                ...
                {/* Footer */}
                <div className="flex flex-col sm:flex-row justify-between items-center p-4 sm:p-6 border-t border-gray-200 text-[10px] sm:text-xs font-zen font-normal sm:text-[12.8px] leading-tight sm:leading-[22.53px] tracking-[-0.5px] text-[#9E9E9E]">
